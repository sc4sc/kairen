...
export default class SafetyContact extends React.Component {
  render() {
    const { container, headerText, contentContainer, circle, notAppliedText, contentContainersecond } = styles;
...
const styles = {
  container: { flex: 1, flexDirection: 'column', justifyContent: 'space-between', backgroundColor: 'white'},
  headerText: { marginTop: 20+topMargin, marginBottom: 40, fontSize: 24, fontWeight: 'bold', letterSpacing: -0.9, color: '#4a4a4a', paddingLeft: 16},
  contentContainer: { flexDirection: 'row', alignItems: 'center', paddingVertical: 15, paddingLeft: 16 },
  contentContainersecond: { height: 48+bottomMargin, flexDirection: 'row',paddingTop: 16, backgroundColor: 'rgb(230,230,230)', paddingLeft: 16},
